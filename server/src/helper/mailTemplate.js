...
async function sendEmail({
  ...
  try {
    ...
    const info = await transporter.sendMail({
      from: `"Erp Request System" <${process.env.MAIL_FROM_ADDRESS}>`,
      to: to,
      cc: cc,
      subject: subject,
          ...
          <tr>
            <td style="background: #f9fafb; padding: 24px; text-align: center; border-top: 1px solid #e5e7eb;">
              ...
              <p style="margin: 0; color: #d1d5db; font-size: 10px;">
                © ${new Date().getFullYear()} Erp Communications. All rights reserved.
              </p>
            </td>
          </tr>
    ...
    <tr>
      <td align="center">
        <table role="presentation" width="600" cellpadding="0" cellspacing="0" border="0" style="max-width:600px;background:#fff;border-radius:8px;overflow:hidden;">
          ...
          <tr>
            <td style="background:#f9fafb;padding:14px;text-align:center;color:#6b7280;font-size:12px;">Erp Operations App • Automated notification</td>
          </tr>
        </table>
      </td>
    </tr>
